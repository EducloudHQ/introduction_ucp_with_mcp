...
class RetailStore:
  ...
  def get_all_products(self) -> ProductResults:
    """Retrieves all products in the catalog.

    Returns:
        ProductResults: All product items in the catalog.
    """
  ...
  def set_buyer(
    ...
    """Sets the buyer information for the checkout.
  ...
  def place_order(self, checkout_id: str) -> Checkout:
    ...
    checkout.order = OrderConfirmation(
        ...
        seller={
            "id": "ucp-retail-store",
            "name": "UCP Retail Store",
        },
        buyer=checkout.buyer.model_dump() if checkout.buyer else None,
    )
